...
namespace StarterGameGem
{
	...
	void* ObjectEntity::GetItemAt(AZ::u32 index)
	{
		...
		{
			CryLog("ObjectListerComponent::ObjectEntity: Attempted to index outside the valid range.");
			return nullptr;
		}
	}
	...
	void* ObjectString::GetItemAt(AZ::u32 index)
	{
		...
		{
			CryLog("ObjectListerComponent::ObjectString: Attempted to index outside the valid range.");
			return nullptr;
		}
	}
	...
	AZ::u32 ObjectListerComponent::GetListSize(AZ::u32 listID)
	{
		...
		{
			CryLog("ObjectListerComponent: Attempted to index a list outside the valid range.");
		}
		return size;
	}
