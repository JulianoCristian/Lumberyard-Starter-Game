...
function uicrosshair:OnActivate()
	...
	self.SetStatusEventId = GameplayNotificationId(self.Properties.Owner, self.Properties.Messages.SetStatusEvent);
	self.SetStatusHandler = GameplayNotificationBus.Connect(self, self.SetStatusEventId);
	self.SetHiddenEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.SetHiddenEvent);
