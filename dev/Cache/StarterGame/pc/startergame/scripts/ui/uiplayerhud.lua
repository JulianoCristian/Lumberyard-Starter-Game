...
function uiplayerhud:OnActivate()
	...
	self.activateUIEventId = GameplayNotificationId(EntityId(), self.Properties.Messages.EnableUIEvent);
	self.activateUIHandler = GameplayNotificationBus.Connect(self, self.activateUIEventId);
	self.HideUIEventId = GameplayNotificationId(EntityId(), self.Properties.Messages.HideUIEventIn);
	self.HideUIHandler = GameplayNotificationBus.Connect(self, self.HideUIEventId);
	self.activateCrosshairEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.EnableCrosshairEvent);
	...
	self.HealthChangedEventId = GameplayNotificationId(self.playerID, self.Properties.Messages.HealthChangedEventIn);
	self.setHealthHandler = GameplayNotificationBus.Connect(self, self.HealthChangedEventId);
	self.setEnergyEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.SetEnergyEventIn);
	self.setEnergyHandler = GameplayNotificationBus.Connect(self, self.setEnergyEventId);
	self.setMapValueEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.SetMapValueEventIn);
	self.setMapValueHandler = GameplayNotificationBus.Connect(self, self.setMapValueEventId);
	self.setCrosshairEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.SetCrosshairEventIn);
	self.setCrosshairHandler = GameplayNotificationBus.Connect(self, self.setCrosshairEventId);
	self.setCrosshairTargetEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.SetCrosshairTargetEventIn);
