...
function UIObjectiveStatus:OnActivate()
	...
	self.SetStatusEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.SetStatusEvent);
	self.SetStatusHandler = GameplayNotificationBus.Connect(self, self.SetStatusEventId);
	self.HideStatusEventId = GameplayNotificationId(self.entityId, self.Properties.Messages.HideStatusEvent);
