...
function particlespawner:OnActivate()
	...
	self.spawnEventId = GameplayNotificationId(self.entityId, self.Properties.ParticleSpawnEvent);
...
function particlespawner:SpawnParticle(params)
	...
	local eventId = GameplayNotificationId(particle, "ParticlePostSpawnParams");
